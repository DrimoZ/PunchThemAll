...
public class TranslationKeys {
    ...
    public static final String INTERACTION_POSITION_SNEAK = "gui." + PunchThemAll.MOD_ID + ".category.position.sneak";
    public static final String INTERACTION_POSITION_UP = "gui." + PunchThemAll.MOD_ID + ".category.position.up";

    public static final String INTERACTION_HAND_NO_ITEM = "gui." + PunchThemAll.MOD_ID + ".category.hand.no_item";
    ...
    public static final String INTERACTION_HAND_COUNT = "gui." + PunchThemAll.MOD_ID + ".category.hand.count";
