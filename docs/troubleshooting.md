...
**Open JEI and look in the Interaction category.** If your interaction is not there, it did not
...
- JEI show what the *server* sent them, so if a client sees an out-of-date list, it is the
